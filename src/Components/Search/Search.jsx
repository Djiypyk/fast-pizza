...
export const Search = ({searchValue, setSearchValue}) => {
    ...
    const changeInput = (event) => {
        if (event.target.value) setSearchValue(event.target.value)
    }
    return (
        <div className={styles.root}>
            ...
            <input className={styles.input} placeholder={'Поиск пиццы...'} value={searchValue}
                   onChange={e => changeInput(e)} type="text"/>

            {searchValue ? <svg className={styles.icon_close}
